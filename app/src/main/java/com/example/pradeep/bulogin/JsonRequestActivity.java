...
public class JsonRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_json_request, menu);
        return true;
    }
    ...
    private void makeJsonObjReq() {
        showProgressDialog();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Const.URL_JSON_OBJECT, null,
